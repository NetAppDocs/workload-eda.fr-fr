...
---
= Découvrez l'intégration de Perforce dans Workload Factory pour l'EDA
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
Workload Factory intègre l'automatisation grâce à _Codebox_. _Codebox_ offre les avantages suivants en matière d'automatisation :
