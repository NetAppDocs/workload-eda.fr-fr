...
---
= Utilisez le tableau de bord Projet dans Workload Factory pour EDA
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
NOTE: Seul le premier administrateur à accéder au tableau de bord du projet peut configurer, ajouter ou supprimer des filtres personnalisés. Tous les autres utilisateurs, y compris les administrateurs suivants, disposent d'un accès en lecture seule aux filtres.
